...
--CREATE USER BANCO_VICENTE IDENTIFIED BY BANCO_VICENTE ;
--GRANT CONNECT, RESOURCE, DBA TO BANCO_VICENTE  ;
...
SELECT AVG(NVL(SALDO,0))  AS SALDO_MEDIO, SUM(SALDO) AS SUMA_TOTAL
FROM CUENTA;
