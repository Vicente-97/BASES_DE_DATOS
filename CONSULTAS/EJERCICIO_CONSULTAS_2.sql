...
--CREATE USER EJERCICIO_CONSULTAS_1 IDENTIFIED BY EJERCICIO_CONSULTAS_1;
--GRANT CONNECT, RESOURCE, DBA TO EJERCICIO_CONSULTAS_1;
...
SELECT  DISTINCT titulacion.nombre, Costebasico  
